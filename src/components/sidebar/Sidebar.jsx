...
const {logout,user,userData}=useContext(AuthenticationContext)
  ...
  const linkList=[
    ...
    {img:Circle,label:"Keşifler",id:"02",to:"/",hasNest:true,subList:[
        {img:MiniCircle,label:"Keşif Fırsatları",id:"08",to:"/kesifler",hasNest:false},
        {img:MiniCircle,label:"Keşiflerim",id:"09",to:"/kesiflerim",hasNest:false},
    ]},
    {img:Mesajlar,label:"Mesajlarım",id:"03",to:"/mesajlarim",hasNest:true,subList:[
        {img:MiniCircle,label:"Canlı Destek",id:"10",to:"/mesajlarim/Canli-Destek",hasNest:false},
        {img:MiniCircle,label:"Destek Talebi",id:"11",to:"/mesajlarim/Destek-Talebi",hasNest:false},
    ]},
    {img:Firmalar,label:"Firma Bilgileri",id:"04",to:"/firma-bilgilerim",hasNest:false},
    {img:CRM,label:"CRM - Çok Yakında",id:"05",to:"/",hasNest:false},
    {img:Wallet,label:"Finans - Çok Yakında",id:"06",to:"/",hasNest:false},
    {img:Firmalar,label:"Depo - Çok Yakında",id:"07",to:"/",hasNest:false},
  ]
  const bottomList=[
   // {img:Kalite,label:"Kalite Puanı",id:"01",to:"/",hasNest:false},
    {img:Settings,label:"Ayarlar",id:"02",to:"/ayarlar",hasNest:true,subList:[
        {img:MiniCircle,label:"Güvenlik",id:"08",to:"/ayarlar",hasNest:false},
        ...
        <div className="sideBarinner">
            ...
            <div className="center">
                ...
                <label>
                    <img 
                    className={`logodiv`}
                    src={user.photoURL?user.photoURL:AddPhoto} alt=""/>
                    
                </label>

                    {Object.keys(userData).length>0&&<Header id='firmName'>{userData?userData.firmName:user?.displayName}</Header>}
                    {Object.keys(userData).length>0&&<SubHeader>Üye Numarası: {new Date().valueOf().toString().substring(0,6)}</SubHeader>}
