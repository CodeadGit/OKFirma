...
function DatatableNew({data,statues}) {
  ...
  const handleChangeForward=()=>{
    ...
    setPage(pre=>pre===0||total-7>0?pre+7:pre+total-pre)
 ...
 stickyHeader
    ...
    >
      ...
      >
        <TableHead style={{backgroundColor:"black",}}>
          <TableRow>
            ...
            width={'5%'}
            align="center">SIRA NO</TableCell>
            <TableCell
            width={"10%"}
            className='headerCell'
            align="center">TALEP ID</TableCell>
            <TableCell
            width={'10%'}
            className='headerCell'
            ...
            width={'10%'}
            className='headerCell'
            align="center">Son Yanıtlayan</TableCell>
            <TableCell
            width={'10%'}
            className='headerCell'
            align="center">KONU</TableCell>
            <TableCell
            width={'10%'}
            className='headerCell'
            align="center">ÖNCELİK</TableCell>
            <TableCell
            width={'10%'}
            className='headerCell'
            ...
            <TableBody>
                ...
                className='tableRowDataContainer'
                    ...
                    width={"10%"}
                    className="textCell"
                    align="center">{data.findIndex(i=>i.id===row.id)+1}</TableCell>
                    <TableCell 
                    width={"10%"}
                    className="textCell"
                    ...
                    width={"10%"}
                    className="textCell"
                    align="center">{row.lastResponse===auth.currentUser.uid?"Siz":"Online Keşif"}</TableCell>
                    <TableCell
                    width={"10%"}
                    ...
                    <TableCell id='actionCell' align="center">
                        ...
                        <span className={`statue ${row.priority}`}>{row.priority}</span>
      ...
      <div className="pagination">
       <div className="left">
           Gösterilen {page+1}-{data.length>7?page+7:data.length} / Toplam : {data.length}
        </div>
        <div className="right">
          <button
        ...
        <div className="empty-area">
            ...
            >Talebiniz Bulunmamaktadır. İsterseniz Yeni Talep Oluşturun</p>
            <img src={Empty} alt="" className='empty-img' />
            <NavLink
            to="/mesajlarim/Yeni-Destek-Talebi"
            className="new-button">Yeni Destek Talebi Oluştur</NavLink>
        </div>}
    </div>
  )
}
