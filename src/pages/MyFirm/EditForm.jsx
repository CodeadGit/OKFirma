...
function EditForm() {
    ...
    const handleSubmit=async(e)=>{
        ...
        await updateDoc(doc(db,"Users",auth.currentUser.uid),{...edit,updatedAt:new Date(),
  ...
  return (
    <div className='formContainer'>
        ...
        {error?<Alert className='alert' severity="error"><span>{error}</span>
        <button
        onClick={()=>setError("")}
        >Tamam</button>
        </Alert>:null}
        {alert?<Alert className='alert' severity="info">
            <span>{alert}</span>
        <button
        onClick={()=>{
            navigate("/")
