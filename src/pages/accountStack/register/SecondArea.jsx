      ...
      <div className="imgContainer">
        <label htmlFor="photo">
          <img
            ...
            src={file ? URL.createObjectURL(file) : AddPhoto}
            alt=""
          />
          <input
            type="file"
      ...
      <div className="zippedSecondArea">
        <div className="inputRow">
          <input
            ...
            onChange={(event) => {
              setRegForm({ ...regForm, firmName: event.target.value });
            }}
          />
          <input
            type="text"
            ...
            onChange={(event) => {
              setRegForm({ ...regForm, TCKN: event.target.value });
            }}
          ...
          <select
            ...
            onChange={(e) =>
              setRegForm({ ...regForm, firmType: e.target.value })
            }
            name="cars"
            id="cars"
          >
            {companyTypes.map((i) => {
              return (
                <option key={i.id} className="selectoption" value={i.label}>
                  {i.label}
                </option>
              );
            })}
        ...
        rows={4}
          ...
          onChange={(event) => {
            setRegForm({ ...regForm, Address: event.target.value });
          }}
        ></textarea>
        <div className="inputRow">
          {/* <input
          ...
          <select
            ...
            onChange={(e) => {
              ...
              setRegion(
                provinces[
                  provinces.findIndex((i) => i.city_name === e.target.value)
                ].districts
              );
            }}
            name="cars"
          ...
          >
            {region.map((i) => {
              return (
                <option key={i} className="selectoption" value={i}>
                  {i}
                </option>
              );
            })}
          ...
          <input
            ...
            onChange={(event) => {
              setRegForm({ ...regForm, ZIP: event.target.value });
            }}
            //onChange={(event)=>{setLoginEmail(event.target.value)}}
          />
        </div>
