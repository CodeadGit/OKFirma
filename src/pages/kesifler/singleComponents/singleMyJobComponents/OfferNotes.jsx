  ...
  return (
    <div className="firm-notes">
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          <DialogContentText>
            Listenize erişmenizin daha kolay olması için ona bir isim verin.{" "}
            <i>
              <smal>(örn: Genel Notlarım)</smal>
            </i>
          </DialogContentText>
          <TextField
            autoFocus
        ...
        <DialogActions>
          ...
          <Button disabled={savingNotes ? true : false} onClick={saveNotes}>
            {savingNotes ? <CircularProgress /> : "Kaydet"}
          </Button>
        </DialogActions>
      </Dialog>
      <div className="one-question">
        ...
        {/* <div className="selectors">
          <span
            ...
            className={`selector ${
              conditions.KDVincluded ? "selected" : "not-selected"
            }`}
          >
            DAHİLDİR
          </span>
      ...
      <div className="one-question">
        ...
        {/* <div className="selectors">
          <span
            ...
            className={`selector ${
              !conditions.angaryaIsOur ? "selected" : "not-selected"
            }`}
          >
            MÜSTERİYE AİTTİR
          </span>
      ...
      {noteList.map((i, idx) => {
        return (
          <div key={idx} className="one-question">
            ...
            />
            <Tooltip title="sil">
              <IconButton onClick={() => handleRemoveNote(i.id)}>
                <Remove />
              </IconButton>
            </Tooltip>
          </div>
      ...
      {/* <div className="action-buttons">
        ...
        <div className="notes-button">
          {notesExist &&
            ...
            !isOne &&
            selectOpen && (
              <select className="select-list" onChange={handleOnChangeSelect}>
                <option value="" disabled selected>
                  Select an option
                </option>
                {savedNotes?.map((s, sidx) => {
                  return (
                    <option value={sidx} key={sidx}>
                      {s.title}
                    </option>
                  );
                })}
